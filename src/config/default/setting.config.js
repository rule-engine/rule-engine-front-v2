...
module.exports = {
    ...
    copyright: '2020-2021 规则引擎(ruleengine.cn), All Rights Reserved, 京ICP备2020034246号-1',     //copyright
    ...
    footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
        {link: 'https://github.com/dingqianwen/rule-engine-front-v2', name: '后台源码'},
        {link: 'https://github.com/dingqianwen/rule-engine-front-v2', icon: 'github'},
        {link: 'https://github.com/dingqianwen/rule-engine-front-v2', name: '文档'}
    ],
}
